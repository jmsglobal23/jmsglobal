          ...
          {Category.map((category) => (
            ...
            >
              ...
              <div className="relative h-56 sm:h-64 md:h-72 overflow-hidden">
                ...
                {/* Title - slides up */}
                <h3 className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white text-lg sm:text-xl md:text-2xl font-bold transition-all duration-500 group-hover:bottom-8">
                  {category.name}
                </h3>
              </div>
